...
class EmployeePendingRequestDetailsScreen extends StatelessWidget {
  ...
  static const String _tr = 'employees_admin_pending_request_page';

  String _t(String key) => '$_tr.$key'.tr();
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSection(
                ...
                children: [
                  ...
                  _buildInfoRow(
                    ...
                    title: _t('employee_id'),
                    value: request.employeeId,
                  ),
                  _buildInfoRow(
                    context,
                    icon: Icons.work_outline_rounded,
                    title: _t('current_job'),
              ...
              _buildSection(
                context,
                title: _t('nomination_data'),
                icon: Icons.emoji_events_outlined,
                children: [
                  _buildInfoRow(
                    context,
                    icon: Icons.campaign_outlined,
                    title: _t('announcement'),
                    value: request.announcementTitle,
                  ),
                  _buildInfoRow(
                    context,
                    icon: Icons.work_history_outlined,
                    title: _t('target_role'),
  ...
  Widget _buildStatusCard(
    ...
    switch (request.status) {
      case EmployeeNominationRequestModel.statusPendingAdmin:
        title = _t('pending_admin');
        description = _t('pending_admin_description');
        icon = Icons.hourglass_top_rounded;
        break;

      case EmployeeNominationRequestModel.statusPendingEvaluator:
        title = _t('pending_evaluator');
        description = _t('pending_evaluator_description');
        icon = Icons.person_search_outlined;
        break;

      case EmployeeNominationRequestModel.statusRejectedByAdmin:
        title = _t('rejected_by_admin');
        description = _t('rejected_by_admin_description');
        icon = Icons.cancel_outlined;
        break;

      case EmployeeNominationRequestModel.statusEvaluated:
        title = _t('evaluated');
        description = _t('evaluated_description');
        icon = Icons.fact_check_outlined;
        break;

      case EmployeeNominationRequestModel.statusFinalApproved:
        title = _t('final_approved');
        description = _t('final_approved_description');
        icon = Icons.check_circle_outline_rounded;
        break;

      case EmployeeNominationRequestModel.statusFinalRejected:
        title = _t('final_rejected');
        description = _t('final_rejected_description');
        icon = Icons.cancel_outlined;
        break;

      case EmployeeNominationRequestModel
          .statusFinalApprovedPendingAnnouncement:
        title = _t('final_approved_pending_announcement');
        description = _t(
  ...
  bool _hasEvaluator() {
    return _hasText(request.evaluatorName);
  }

  bool _hasInterviewData() {
    return request.interviewDate != null ||
        _hasText(request.interviewLocation) ||
        _hasText(request.interviewTime);
  }
